<?php
/**
 * Template Name: Three Listings Payment Form
 *
 */
...
$amount = paystack_price_convert(2000);

$verification_url = "localhost/propatiz/three-listings-paystack-verification/";
	...
	<div class="dashboard-container">
		...
		<div class="dashboard-contents">
            ...
            <div class="field-full-width">
                    <p class="paystack-amount">₦2,000</p>
            </div>
