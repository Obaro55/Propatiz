<?php
/**
 * Template Name: Promoted Listings Payment Form
 *
 */
...
$amount = paystack_price_convert(5000);

$verification_url = "http://localhost/propatiz/promoted-listings-paystack-verification/";
	...
	<div class="dashboard-container">
		...
		<div class="dashboard-contents">
            ...
            <div class="field-full-width">
                    <p class="paystack-amount">₦5,000</p>
            </div>
